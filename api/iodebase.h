...
extern char *T_cell_pack(char *,TCELL *);
...
extern int KT_print_cell(FILE *,TCELL *);
...
extern int wks_string(char *,int ,int );
extern int wks_value(double ,int ,int );
extern int wks_name(char *,int ,int ,int ,int );
...
extern void EXP_vec_csv(EXPDEF *,char *,char *,char *);
extern int EXP_hd_rcsv(EXPDEF *,KDB *,KDB *,char *);
extern char *EXP_elem_rcsv(KDB *,int ,int ,char **);
extern void EXP_vec_rcsv(EXPDEF *,char *,char *,char *);
...
extern void EXP_vec_dif(EXPDEF *,char *,char *,char *);
...
extern void EXP_vec_tsp(EXPDEF *,char *,char *,char *);
...
extern void EXP_vec_wks(EXPDEF *,char *,char *,char *);
