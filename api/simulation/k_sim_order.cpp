 ...
 * List of functions 
 * -----------------
 *      int KE_order(std::shared_ptr<KDBEquations> dbe, char** eqs)              Reorders a model before the simulation to optimise the execution order of the set of equations.
 *      int KE_poseq(int posendo)                       Searches the equation whose endogenous is the variable posendo. 
 *      void KE_tri(std::shared_ptr<KDBEquations> dbe, int** predecessors, int passes)    Sort the equations by making successive 'pseudo-triangulation' passes.
 */
 ...
 *  
 */
int CSimulation::KE_pre(std::shared_ptr<KDBEquations> dbe, int** predecessors, int from)
{
    int     i, j,
            c = 1, nb = 0;
 ...
 *  
 */
int CSimulation::KE_interdep(std::shared_ptr<KDBEquations> dbe, int** predecessors)
{
    int     i, nb = 0;
 ...
 *  
 */
int CSimulation::KE_postorder(std::shared_ptr<KDBEquations> dbe, int** predecessors, int** successors)
{
    int     i;
 ...
 *  
 */
int CSimulation::KE_preorder(std::shared_ptr<KDBEquations> dbe, int** predecessors, int** successors)
{
    int     pos, posj, nb;
    CLEC    *clec;
 ...
 *  
 */
void CSimulation::KE_order(std::shared_ptr<KDBEquations> dbe, char** eqs)
{
 ...
 *  
 */
int CSimulation::KE_tri_begin(std::shared_ptr<KDBEquations> dbe)
{
    int     i, nb;
...
int CSimulation::KE_tri_end(std::shared_ptr<KDBEquations> dbe)
{
    int     i;
 ...
 *  
 */
void CSimulation::KE_tri_perm1(std::shared_ptr<KDBEquations> dbe, int i, int* vars)
{
 ...
 *  
 */
void CSimulation::KE_tri(std::shared_ptr<KDBEquations> dbe, int** predecessors, int passes)
{
    int     i, var, j;
    int     cpu_sort;
