...
int     nb, nbper;
{
    ...
    IODE_REAL    *ai = SW_nalloc(nb * sizeof(IODE_REAL)),
	    *bi = SW_nalloc(nb * sizeof(IODE_REAL)),
	    *ci = SW_nalloc((nb + 14) * sizeof(IODE_REAL)),
/*
	    *c1 = SW_nalloc(nb * sizeof(IODE_REAL)),
	    *i1 = SW_nalloc(nb * sizeof(IODE_REAL)),
*/
	    *m5 = SW_nalloc(nb * sizeof(IODE_REAL)),
	    *ma = SW_nalloc((nbj + 4) * sizeof(IODE_REAL)),
	    *ma7 = SW_nalloc((nbj + 6) * sizeof(IODE_REAL)),
	    s[12], d, di1;
