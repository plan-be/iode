 ...
 *  ----------------- 
 *
 *      double L_zero(std::shared_ptr<KDBVariables> dbv, std::shared_ptr<KDBScalars> dbs, CLEC* clec, int t, int varnb, int eqvarnb)    Solves numerically a LEC equation for one period of time with respect to a given variable. 
 *                                                                                      If the Newton-Raphson method does not reach a solution, tries a bisection (secant) method. 
 *      double L_newton(std::shared_ptr<KDBVariables> dbv, std::shared_ptr<KDBScalars> dbs, CLEC* clec, int t, int varnb, int eqvarnb)  Tries to solve a LEC equation by the Newton-Raphson method. 
 *  
 */
#include <math.h>
 ...
 *  
 */
static double L_newton_1(int algo, std::shared_ptr<KDBVariables> dbv, std::shared_ptr<KDBScalars> dbs, CLEC* clec, int t, 
