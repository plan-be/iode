 ...
 *  ----------------- 
 *
 *      double L_zero(KDBVariables* dbv, std::shared_ptr<KDBScalars> dbs, CLEC* clec, int t, int varnb, int eqvarnb)    Solves numerically a LEC equation for one period of time with respect to a given variable. 
 ...
 *  
 */
double L_zero(KDBVariables* dbv, std::shared_ptr<KDBScalars> dbs, CLEC* clec, int t, int varnb, int eqvarnb)
{
 ...
 *  
 */
static double L_newton_1(int algo, KDBVariables* dbv, std::shared_ptr<KDBScalars> dbs, CLEC* clec, int t, 
 ...
 *    
 */
double L_newton(KDBVariables* dbv, std::shared_ptr<KDBScalars> dbs, CLEC* clec, int t, int varnb, int eqvarnb)
{
