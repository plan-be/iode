 ...
 *   - L_REAL L_exec(KDBVariables* dbv, KDBScalars* dbs, CLEC* expr, int t)                     Execution of a compiled and linked CLEC expression.
 ...
 */
L_REAL L_exec(KDBVariables* dbv, KDBScalars* dbs, CLEC* expr, int t)
{
    int	pos; //short   pos;
