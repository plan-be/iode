 ...
 *  
 */
int EXP_Ws(ExportToFile* expdef, std::shared_ptr<KDBVariables> dbv, std::shared_ptr<KDBComments> dbc, char* rulefile, 
 ...
 *  
 */
int EXP_Rev_Ws(ExportToFile* expdef, std::shared_ptr<KDBVariables> dbv, std::shared_ptr<KDBComments> dbc, char* rulefile, 
               char* outfile, char* na, char* sep)
{
    int     i, j, nl, nc, rc;
    char    *code = NULL;
