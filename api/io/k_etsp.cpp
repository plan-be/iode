...
char* ExportObjsTSP::extract_comment(std::shared_ptr<KDBComments> dbc, char* name, char** cmt)
{
...
char* ExportObjsTSP::get_variable_value(std::shared_ptr<KDBVariables> dbv, int nb, int t, char** vec)
{
    int     lg, olg;
