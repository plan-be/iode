...
struct ExportToFile 
{
    ...
    virtual int   write_header(const KDBVariablesPtr dbv_ptr, const KDBCommentsPtr dbc_ptr, char* outfile) { return 0; }                      // method that creates the output file and writes the header
...
int EXP_Ws(const std::unique_ptr<ExportToFile>& expdef, const KDBVariablesPtr dbv_ptr, const KDBCommentsPtr dbc_ptr, char* rulefile, char* outfile, char* na, char* sep);
int EXP_Rev_Ws(const std::unique_ptr<ExportToFile>& expdef, const KDBVariablesPtr dbv_ptr, const KDBCommentsPtr dbc_ptr, char* rulefile, char* outfile, char* na, char* sep);
