...
struct ExportToFile 
{
    ...
    virtual char* extract_comment(std::shared_ptr<KDBComments>, char*, char**) { return 0; }                                // method to create the output object comment (if it exists in global_ws_cmt) + the separator for the output file
    virtual char* get_variable_value(std::shared_ptr<KDBVariables>, int, int, char**){ return 0; }                           // method constructing an allocated string of one value + sep
...
struct ExportObjsCSV : public ExportToFile
{
    ...
    char* extract_comment(std::shared_ptr<KDBComments>, char*, char**) override;
...
int EXP_Ws(ExportToFile* expdef, std::shared_ptr<KDBVariables> dbv, std::shared_ptr<KDBComments> dbc, char* rulefile, char* outfile, char* na, char* sep);
int EXP_Rev_Ws(ExportToFile* expdef, std::shared_ptr<KDBVariables> dbv, std::shared_ptr<KDBComments> dbc, char* rulefile, char* outfile, char* na, char* sep);
