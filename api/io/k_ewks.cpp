...
char* ExportObjsWKS::extract_comment(std::shared_ptr<KDBComments> dbc, char* name, char** cmt)
{
...
char* ExportObjsWKS::get_variable_value(std::shared_ptr<KDBVariables> dbv, int nb, int t, char** vec)
{
    char* buf = NULL;
