 ...
 *  @return          char*          *vec
 */
char* ExportObjsCSV::get_variable_value(KDBVariables* dbv, int nb, int t, char** vec)
{
    int     lg, olg;
...
char* ExportObjsRevertCSV::get_variable_value(KDBVariables* dbv, int nb, int t, char** vec)
{
    char  tmp[81]; 
    char* buf = NULL;
