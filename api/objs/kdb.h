...
public:
        ...
        const std::string& dest_key) const
    {
        ...
        dest.k_objs[dest_key] = obj_copy_ptr;
    }
        ...
        const std::string& dest_key)
    {
        ...
        T* obj_copy_ptr = new T(*obj_ptr);
        this->k_objs[dest_key] = obj_copy_ptr;
    }
    ...
    virtual void set_obj_ptr(const std::string& name, T* obj_ptr)
    {
        std::string key = to_key(name);
        if(key.empty())
        {
    ...
    virtual bool add(const std::string& name, const T& obj)
    {
        ...
        T* new_obj_ptr = new T(obj);
        this->set_obj_ptr(name, new_obj_ptr);
        return true;
    }
    ...
    virtual void update(const std::string& name, const T& obj)
    {
        ...
        T* updated_obj_ptr = new T(obj);
        this->set_obj_ptr(name, updated_obj_ptr);
    }
};
