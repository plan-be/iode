...
enum TableLineType
{
	TABLE_LINE_FILES = TABLE_ASCII_LINE_FILES,  // 105
	TABLE_LINE_MODE  = TABLE_ASCII_LINE_MODE,   // 106
	TABLE_LINE_CELL  = TABLE_ASCII_LINE_CELL,   // 110
	TABLE_LINE_SEP   = TABLE_ASCII_LINE_SEP,    // 111
	TABLE_LINE_TITLE = TABLE_ASCII_LINE_TITLE,  // 113
	TABLE_LINE_DATE  = TABLE_ASCII_LINE_DATE    // 116
};
...
struct KDBTables : public KDBTemplate<Table>
{
    ...
    KDBTables(const std::shared_ptr<KDBTables> db_parent, const std::string& pattern, const bool copy) 
