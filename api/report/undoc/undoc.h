...
int IODE_CDECL B_DSImportDb(char *arg);

/* b_global.c */
int B_ScrollSet(char *,long *,int ,int );
int B_ScrollVarW(char *);
int B_ScrollVarN(char *);
int B_ScrollVarM(char *);
int B_ScrollVarS(char *);
int B_ScrollSclW(char *);
int B_ScrollSclN(char *);
int B_ScrollTblW(char *);
int B_ScrollVTW(char *);
int B_ScrollVTW0(char *);
int B_ScrollVTN(char *);
...
int B_PrintObjTblTitle(char *);
int B_PrintObjLec(char *);
int B_PrintObjEqsInfos(char *);
int B_PrintObjDef_1(char *,int *);
int B_PrintObjDef(char *,int );
int B_PrintObjDefArgs(char *,int );
...
int B_ViewVar(char *);
int B_PrintVar(char *);
int B_ViewPrintVar(char *,int );
int B_ViewByTbl(char *);
int B_ViewTbl(char *);
int B_PrintTbl(char *);
int B_ViewGr(char *);
int B_PrintGr(char *);
...
int B_ViewPrintTbl(char *,int ,int );
int B_ViewTblFile(char *);
