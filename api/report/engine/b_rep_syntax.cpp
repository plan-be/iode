...
extern std::map<std::string, BFNS> B_fns = 
{
    ...
    {"quit",                   {"quit",                     RP_quitode,             RP_quitode,         0,        0}},
...
//  {"showoff                  {"showoff",                  RP_message_off,         RP_message_off,     0,        0}},
    ...
    {"undef",                  {"undef",                    RP_undef,               RP_undef,           0,        0}},
    {"undefine",               {"undefine",                 RP_undef,               RP_undef,           0,        0}},
    {"debug",                  {"debug",                    RP_setdebug,            RP_setdebug,        0,        0}},
    {"indent",                 {"indent",                   RP_setindent,           RP_setindent,       0,        0}},
    {"multiline",              {"multiline",                RP_setmultiline,        RP_setmultiline,    0,        0}},
    {"noparsing",              {"noparsing",                RP_noparsing,           RP_noparsing,       0,        0}},
    {"shellexec",              {"shellexec",                B_shellexec,            B_shellexec,        0,        0}},
    {"repeat",                 {"repeat",                   RP_repeat,              RP_repeat,          0,        0}},
    {"repeatstring",           {"repeatstring",             RP_repeatstring,        RP_repeatstring,    0,        0}},
    {"vseps",                  {"vseps",                    RP_vseps,               RP_vseps,           0,        0}},
    {"foreach",                {"foreach",                  RP_foreach,             RP_foreach,         0,        0}},
    {"next",                   {"next",                     RP_foreach_next,        RP_foreach_next,    0,        0}},
    {"procdef",                {"procdef",                  RP_procdef,             RP_procdef,         0,        0}},
    {"procexec",               {"procexec",                 RP_procexec,            RP_procexec,        0,        0}},
    ...
    {"wsimporteviews",		  {"WsImportEviews",			B_WsImportEviews,       NULL, 		        0,        1}},
...
//  {"dataupdateblock",        {"DataUpdateBlock",          B_DataUpdateBlock,      NULL,               1,        1}},
    ...
    {"datarasvar",             {"DataRasVar",               B_DataRasVar,           NULL,               0,        1}},
    {"datascan",               {"DataScan",                 B_DataScan,             SB_DataScan,        1,        1}},
    {"datapattern",            {"DataPattern",              B_DataPattern,          NULL,               1,        1}},
    ...
    {"datawidthvar",           {"DataWidthVar",             B_ScrollVarW,           NULL,               0,        1}},
    {"datandecvar",            {"DataNdecVar",              B_ScrollVarN,           NULL,               0,        1}},
    {"datamodevar",            {"DataModeVar",              B_ScrollVarM,           NULL,               0,        1}},
    {"datastartvar",           {"DataStartVar",             B_ScrollVarS,           NULL,               0,        1}},
    {"datawidthtbl",           {"DataWidthTbl",             B_ScrollTblW,           NULL,               0,        1}},
    {"datawidthscl",           {"DataWidthScl",             B_ScrollSclW,           NULL,               0,        1}},
    {"datandecscl",            {"DataNdecScl",              B_ScrollSclN,           NULL,               0,        1}},
    {"viewwidth",              {"ViewWidth",                B_ScrollVTW,            NULL,               0,        1}},
    {"viewwidth0",             {"ViewWidth0",               B_ScrollVTW0,           NULL,               0,        1}},
    {"viewndec",               {"ViewNdec",                 B_ScrollVTN,            NULL,               0,        1}},
    {"printobjtitle",          {"PrintObjTitle",            B_PrintObjTblTitle,     NULL,               0,        1}},
    {"printobjlec",            {"PrintObjLec",              B_PrintObjLec,          NULL,               0,        1}},
    {"printobjinfos",          {"PrintObjInfos",            B_PrintObjEqsInfos,     NULL,               0,        1}},
...
//  {"printgrwin",             {"PrintGrWin",               B_PrintGrWin,           SB_ViewPrintGr,     0,        1}},
    ...
    {"eqssetblock",            {"EqsSetBlock",              B_EqsSetBloc,           NULL,               0,        1}},
    ...
    {"printrtfcopyright",      {"PrintRtfCopyright",        B_PrintRtfCopy,         NULL,               0,        1}},
    ...
    {"printorientation",       {"PrintOrientation",         B_PrintGdiOrient,       NULL,               0,        1}},
    {"printduplex",            {"PrintDuplex",              B_PrintGdiDuplex,       NULL,               0,        1}},
    {"setprinter",             {"SetPrinter",               B_PrintGdiPrinter,      NULL,               0,        1}},

    {"printgiftranscolor",     {"PrintGIFTransColor",       B_PrintGIFTransColor,   NULL,               0,        1}},
    ...
    {"csvsave",                {"CsvSave",                  B_CsvSave,              NULL,               3,        1}},
    {"csvdigits",              {"CsvDigits",                B_CsvNbDec,             NULL,               0,        1}},
    {"csvsep",                 {"CsvSep",                   B_CsvSep,               NULL,               0,        1}},
    {"csvdec",                 {"CsvDec",                   B_CsvDec,               NULL,               0,        1}},
    {"csvnan",                 {"CsvNaN",                   B_CsvNaN,               NULL,               0,        1}},
    {"csvaxes",                {"CsvAxes",                  B_CsvAxes,              NULL,               0,        1}}
};

// ========= Definition of report @-functions =========

extern std::map<std::string, RPFN> RP_FNS = 
{
    {"upper",            {RPF_upper}},
    {"date",             {RPF_date}},
    {"time",             {RPF_time}},
    ...
    {"ivalue",           {RPF_ivalue}},
    {"evalue",           {RPF_evalue}},
    {"eqsample",         {RPF_eqsample}}, 
    {"eqsamplefrom",     {RPF_eqsamplefrom}}, 
    {"eqsampleto",       {RPF_eqsampleto}}, 
    {"eqlhs",            {RPF_eqlhs}}, 
    {"eqrhs",            {RPF_eqrhs}}, 
    {"vliste",           {RPF_vliste}},
    {"sliste",           {RPF_sliste}},
