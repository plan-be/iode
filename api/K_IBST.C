...
int     lang;
{
	...
	lrub = floor(log10((double) rub));
	switch(lrub) {
	   case 0  :
		sprintf(name, "C000%ld_%ld", rub, niv); break;
	   case 1  :
		sprintf(name, "C00%ld_%ld", rub, niv); break;
	   case 2  :
		sprintf(name, "C0%ld_%ld", rub, niv); break;
	   case 3  :
		sprintf(name, "C%ld_%ld", rub, niv); break;
	   default :
	      return(-1);
	}
