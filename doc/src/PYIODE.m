...
&TI Introduction
¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
The present version of the python module for IODE implements a significative part of the IODE API. 
The aim is to implement the complete set of IODE functions.

&TI Python version & iode.pyd path
¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
Each version of python has its own file ~ciode.pyd~C (the IODE python module).
