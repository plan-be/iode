...
���������������������
Lorqu'un m�me message d'erreur est g�n�r� successivement � plusieurs reprises, une seule version est
...
ne g�n�re plus de message d'erreur.
...
���������������������
L'impression de certains objet de taille importante pouvait g�n�rer un arr�t de IODE. Le texte g�n�r� est 
dor�navant tronqu� � 10K. 
...
Ce path peut (en partie) �tre calcul� en python. Voici comment proc�der : 
...
&CO
  ...
  ## On prend ici comme hypoth�se que le directory d'installation de IODE est ~cc:/iode~C
...
Dans les versions pr�c�dentes, la taille des segments pouvait �tre modifi�e par le param�tre ~c-seg~C de ~ciode.exe~C. 
Par exemple, pour des segments de 100000 bytes :
&CO
    iode -seg 100000
&TX

On peut dor�navant fixer la taille des segments via le param�tre ~cGeneral / SegSize~C dans le fichier ~ciode.ini~C 
qui se trouve dans le m�me r�pertoire que le programme appelant (iode.exe, iodecmd.exe).
...
La raison en est que le caract�re de s�paration de colonnes (Cell separator)
...
param�tres A2M ~c(File/Print Setup/Options/A2M)~C �tait diff�rente du
caract�re hardcod� ('&'), l'impression �tait tronqu�e.

Ce bug est corrig�: on peut maintenant choisir un autre caract�re "Cell Separator" que '&'.
>
...
&IT Recherche des objets de m�me nom ou contenus dans l'objet courant

Ainsi, dans le tableau de variables, lorque le curseur est plac� sur la variable ~cACAF~C,
~cAlt+F1~C ouvre une fen�tre avec le commentaire du m�me nom. Selon le type d'objet, la liste
affich�e peut �tre diff�rente : pour les listes d'�quations ou d'identit�s, toutes les
...
Cette deuxi�me option peut �tre (d�s-)activ�e de deux fa�ons :
&EN en allant � l'�cran File/Print Setup, sous page Printer, et en (d�s-)s�lectionnant
  le champ "Prompt printer".
&EN en �ditant le fichier iode.ini qui se trouve dans le m�me directory que l'ex�cutable iode.exe
et en fixant � 1 (ou 0) l le valeur du param�tre ~c[A2MGDI] Prompt~C.


&TI Param�tres d'impressions
���������������������������
Dans l'�cran des options d'impression (File/Print Setup/Options), l'utilisateur a acc�s,
pour chaque destination d'"impression", � certains param�tres comme la police de caract�res
...
Dans les versions pr�c�dentes certains param�tres �taient partag�s entre les diff�rentes destination.
C'�tait en particulier le cas pour les polices et les tailles de caract�res. A partir de cette version,
ces valeurs sont sp�cifiques � cette seule destination et peuvent donc �tre diff�renci�s par l'utilisareur
...
Si c'est le cas, le caract�re de retour � la ligne est ins�r� entre les lignes ~c(\n)~C.
...
��������������������������
La d�finition d'une macro peut �tre supprim�e par la commande $undef ou $undefine.
...
����������������������
Dans la syntaxe de cette fonction dans le manuel, la position du param�tre nbtri
�tait incorrecte : elle devait se trouver entre les deux param�tres de debugging et non � la fin.
...
A noter aussi que pour des raisons historiques, "Both" est �quivalent � "Triangulation" comme 4e param�tre de l'appel � la fonction.
...
� l'�cran et le programme attend la r�ponse de l'utilisateur : si un des caract�res "OoJjYy1" est entr�, la r�ponse
est positive et le rapport se poursuit au label indiqu�.

&TI Noms des fichiers ascii apr�s lecture dans IODE
���������������������������������������������������
...
&EN si le fichier existe, le WS conserve le nom du fichier lu mais l'extension
    est remplac�e par l'extension ascii ~ustandard~U, ici ~c"test.av"~C (m�me pour ~c"test.xxx"~C );

&EN si le fichier n'existe pas et qu'il n'a pas d'extension (par exemple ~c"test"~C )
et qu'un fichier avec le m�me nom mais avec l'extension standard
(ici ~c"test.var"~C) existe, c'est ce fichier ~c"test.var"~C qui est lu et le nom
du ws devient ~c"test.var"~C;


&IT Param�tres d'impression et fichier iode.ini
�����������������������������������������������
Les param�tres d'impressions sont dor�navant d�finis dans le fichier "iode.ini". Ce fichier se trouve dans le m�me r�pertoire que
le programme iode lui-m�me, par exemple c:\iode. Ce fichier peut �tre �dit� manuellement par l'utilisateur via un �diteur de
fichier texte comme notepad++.

Alternativement, les param�tres d'impression d�finis dans iode.ini peuvent �tre modifi�s
...
~uUtilisation des param�tres d'impression~U
