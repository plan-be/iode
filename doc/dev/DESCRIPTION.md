...
|`KDB *K_interpret(int type, char* filename, int db_global): generalisation of load()`|interprets the content of a file, ascii files includes, and try to load ist content into a KDB.|
