...
|Syntax|Description|
|:---|:---|
|`int KE_est_s(KDBEquationsPtr dbe, KDBVariablesPtr dbv, KDBScalarsPtr dbs, Sample* smpl, char** names)`|Estimates an equation or a block of equations|
...
|Syntax|Description|
|:---|:---|
|`int E_est(char** endos, char** lecs, KDBVariablesPtr dbv, KDBScalarsPtr dbs, Sample* smpl, int met, char** instrs, int maxit, double eps)`|Estimates a block of equations|
|**Utility function**||
