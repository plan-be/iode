...
\begin{tabular}{ p{0.4\textwidth} p{0.6\textwidth} }
    ...
    Shift + F7          & Execute identities for a range of periods \\ 
    F8                  & Show the current variable in a graph \\ 
    Shift + F8          & Open the dialog box to display variables as a graph (variables only) \\
    ...
    Ctrl + [F1-F7]      & Allow to move the window of objects \\
