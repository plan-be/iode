...
\begin{tabular}{ p{0.4\textwidth} p{0.6\textwidth} }
    ...
    \hline
    Ctrl + F[1-7]       & shows the [comments - variables] containing to the current 
                          IODE object \\
...
\begin{tabular}{ p{0.4\textwidth} p{0.6\textwidth} }
    ...
    Shift + Insert       & Paste the clipboard text \\
    \hline
    backspace            & Delete the previous character \\
    Delete               & Delete the next character \\
    Ctrl + Backspace	 & Delete from cursor to the start of word \\	      
    Ctrl + Delete	     & Delete from cursor to the end of word \\	          
    ...
    \hline 
    Alt + left-click \newline Ctrl + Alt + $\uparrow$/$\downarrow$ 
                         & Enable multiple cursors \\
    Esc                  & Stop multiple cursors \\
    \hline 
    Enter / Space        & Stop auto-complete \\
    Tab                  & Auto-complete with first proposed word \\
    Ctrl + Space         & Force start auto-complete 	          
\end{tabular}
\newline\newline
...
\begin{tabular}{ p{0.4\textwidth} p{0.6\textwidth} }
    ...
    Ctrl + Shift + $\rightarrow$   & Select the next word \\	        
    Ctrl + Shift + $\leftarrow$	   & Select the previous word \\	    
    Shift + $\downarrow$	       & Select the next line \\	        
    Shift + $\uparrow$ 	           & Select the previous line \\	    
    Shift + PgDown	               & Select the next page \\	        
    Shift + PgUp	               & Select the previous page \\	    
    Shift + Home	               & Select the start of line \\	    
    Shift + End	                   & Select the end of line \\	
    Ctrl + L                       & Select the current line \\    
    Ctrl + Shift + Home	           & Select the start of editor \\	
    Ctrl + Shift + End	           & Select the end of editor \\
