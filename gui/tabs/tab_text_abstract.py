from PyQt6.QtWidgets import QWidget, QPlainTextEdit, QMessageBox, QGridLayout, QFileDialog
from PyQt6.QtCore import pyqtSignal, pyqtSlot, Qt, QFileInfo, QTextStream
...
class AbstractTextWidget(IodeAbstractWidget):
    ...
    tab_text_modified = pyqtSignal(str, bool)
    ...
    def _load_(self, editor: QPlainTextEdit, filepath: str) -> bool:
        """
        ...
        try:
            with open(filepath, 'r') as file:
                ...
                if editor.toPlainText() == file_content:
                    return False
    ...
    def _save(self, editor: QPlainTextEdit, filepath: str) -> Optional[str]:
        """
