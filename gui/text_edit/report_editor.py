...
from print.print import IodeGuiPrint
...
from iode import TableLang, execute_report
...
class IodeReportEditor(IodeTextEditor):
    ...
    def run(self, filepath: str, parameters: Union[str, List[str]], nb_decimals: int, language: TableLang):
        ...
        run_from_project_dir = project_settings.value(MenuFileSettings.KEY_SETTINGS_RUN_REPORTS_FROM_PROJECT_DIR, type=bool)
        ...
        try:
            ...
            IodeGuiPrint(nb_decimals, language)
