 ...
 */
PrintGraphsTablesDialog::PrintGraphsTablesDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::print_graphs_tables();
    ui->setupUi(this);
...
PrintGraphsTablesDialog::~PrintGraphsTablesDialog()
{
    delete ui;
}

void PrintGraphsTablesDialog::display()
{
// TODO: implement this
}

void PrintGraphsTablesDialog::print()
{
// TODO: implement this
}

void PrintGraphsTablesDialog::setup()
{
// TODO: implement this
}
