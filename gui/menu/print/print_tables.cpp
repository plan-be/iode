 ...
 */
PrintTablesDialog::PrintTablesDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::print_tables();
    ui->setupUi(this);
...
PrintTablesDialog::~PrintTablesDialog()
{
    delete ui;
}

void PrintTablesDialog::display()
{
// TODO: implement this
}

void PrintTablesDialog::print()
{
// TODO: implement this
}

void PrintTablesDialog::setup()
{
// TODO: implement this
}
