 ...
 */
PrintA2MFileDialog::PrintA2MFileDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::print_A2M_file();
    ui->setupUi(this);
...
PrintA2MFileDialog::~PrintA2MFileDialog()
{
    delete ui;
}

void PrintA2MFileDialog::print()
{
// TODO: implement this
}

void PrintA2MFileDialog::setup()
{
// TODO: implement this
}
