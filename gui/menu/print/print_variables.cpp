 ...
 */
PrintVariablesDialog::PrintVariablesDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::print_variables();
    ui->setupUi(this);
...
PrintVariablesDialog::~PrintVariablesDialog()
{
    delete ui;
}

void PrintVariablesDialog::display()
{
// TODO: implement this
}

void PrintVariablesDialog::print()
{
// TODO: implement this
}

void PrintVariablesDialog::setup()
{
// TODO: implement this
}
