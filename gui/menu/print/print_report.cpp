 ...
 */
PrintReportDialog::PrintReportDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::print_report();
    ui->setupUi(this);
...
void PrintReportDialog::print()
{
// TODO: implement this
}

void PrintReportDialog::setup()
{
// TODO: implement this
}
