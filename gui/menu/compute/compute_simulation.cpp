 ...
 */
ComputeSimulationDialog::ComputeSimulationDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::compute_simulation();
    ui->setupUi(this);
...
ComputeSimulationDialog::~ComputeSimulationDialog()
{
    delete ui;
}

void ComputeSimulationDialog::compute()
{
// TODO: implement this
}
