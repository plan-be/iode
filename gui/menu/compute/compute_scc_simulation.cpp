 ...
 */
ComputeSccSimulationDialog::ComputeSccSimulationDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::compute_scc_simulation();
    ui->setupUi(this);
...
ComputeSccSimulationDialog::~ComputeSccSimulationDialog()
{
    delete ui;
}

void ComputeSccSimulationDialog::compute()
{
// TODO: implement this
}
