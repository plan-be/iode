 ...
 */
ComputIdentitiesDialog::ComputIdentitiesDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::comput_identities();
    ui->setupUi(this);
...
ComputIdentitiesDialog::~ComputIdentitiesDialog()
{
    delete ui;
}

void ComputIdentitiesDialog::compute()
{
// TODO: implement this
}
