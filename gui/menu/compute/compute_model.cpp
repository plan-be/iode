 ...
 */
ComputeModelDialog::ComputeModelDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::compute_model();
    ui->setupUi(this);
...
ComputeModelDialog::~ComputeModelDialog()
{
    delete ui;
}

void ComputeModelDialog::compute()
{
// TODO: implement this
}
