 ...
 */
ComputeSccDecompositionDialog::ComputeSccDecompositionDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::compute_scc_decomposition();
    ui->setupUi(this);
...
ComputeSccDecompositionDialog::~ComputeSccDecompositionDialog()
{
    delete ui;
}

void ComputeSccDecompositionDialog::compute()
{
// TODO: implement this
}
