 ...
 */
ReportEditDialog::ReportEditDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::report_edit();
    ui->setupUi(this);
...
ReportEditDialog::~ReportEditDialog()
{
    delete ui;
}

void ReportEditDialog::open()
{
// TODO: implement this
}
