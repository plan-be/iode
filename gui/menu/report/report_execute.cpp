 ...
 */
ReportExecuteDialog::ReportExecuteDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::report_execute();
    ui->setupUi(this);
...
ReportExecuteDialog::~ReportExecuteDialog()
{
    delete ui;
}

void ReportExecuteDialog::execute_report()
{
// TODO: implement this
}
