 ...
 */
ReportCommandLineDialog::ReportCommandLineDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::report_command_line();
    ui->setupUi(this);
...
ReportCommandLineDialog::~ReportCommandLineDialog()
{
    delete ui;
}

void ReportCommandLineDialog::execute_command_line()
{
// TODO: implement this
}
