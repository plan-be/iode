 ...
 */
SaveSettingsDialog::SaveSettingsDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::save_settings();
    ui->setupUi(this);
...
void SaveSettingsDialog::save_settings()
{
// TODO: implement this
}
