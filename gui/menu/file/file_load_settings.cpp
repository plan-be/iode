 ...
 */
LoadSettingsDialog::LoadSettingsDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::load_settings();
    ui->setupUi(this);
...
void LoadSettingsDialog::load_settings()
{
// TODO: implement this
}
