 ...
 */
LowToHighDialog::LowToHighDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::low_to_high();
    ui->setupUi(this);
...
LowToHighDialog::~LowToHighDialog()
{
    delete ui;
}
