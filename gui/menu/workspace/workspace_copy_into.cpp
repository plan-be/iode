 ...
 */
CopyIntoWorkspaceDialog::CopyIntoWorkspaceDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::copy_into_workspace();
    ui->setupUi(this);
...
CopyIntoWorkspaceDialog::~CopyIntoWorkspaceDialog()
{
    delete ui;
}

void CopyIntoWorkspaceDialog::copy_into_workspace()
{
// TODO: implement this
}
