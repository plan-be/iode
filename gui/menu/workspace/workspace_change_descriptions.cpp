...
#include "workspace_change_descriptions.h"
 ...
 */
ChangeWorkspaceDescriptionsDialog::ChangeWorkspaceDescriptionsDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::change_workspace_descriptions();
    ui->setupUi(this);
...
ChangeWorkspaceDescriptionsDialog::~ChangeWorkspaceDescriptionsDialog()
{
    delete ui;
}

void ChangeWorkspaceDescriptionsDialog::change_descriptions()
{
// TODO: implement this
}
