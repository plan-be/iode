 ...
 */
ExtrapolateVariablesDialog::ExtrapolateVariablesDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::extrapolate_variables();
    ui->setupUi(this);
...
ExtrapolateVariablesDialog::~ExtrapolateVariablesDialog()
{
    delete ui;
}

void ExtrapolateVariablesDialog::extrapolate_variables()
{
// TODO: implement this
}
