 ...
 */
MergeIntoWorkspaceDialog::MergeIntoWorkspaceDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::merge_into_workspace();
    ui->setupUi(this);
...
MergeIntoWorkspaceDialog::~MergeIntoWorkspaceDialog()
{
    delete ui;
}

void MergeIntoWorkspaceDialog::merge_into_workspace()
{
// TODO: implement this
}
