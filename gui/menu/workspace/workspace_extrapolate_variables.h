...
class ExtrapolateVariablesDialog : public MixinSettings
{
    Q_OBJECT

private:
    Ui::extrapolate_variables* ui;

public:
    ExtrapolateVariablesDialog(QSettings& settings, QWidget* parent = nullptr, Qt::WindowFlags f = Qt::WindowFlags());
    ~ExtrapolateVariablesDialog();
