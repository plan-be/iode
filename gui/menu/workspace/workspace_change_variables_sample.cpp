...
#include "workspace_change_variables_sample.h"
 ...
 */
ChangeVariablesSampleDialog::ChangeVariablesSampleDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::change_variables_sample();
    ui->setupUi(this);
...
ChangeVariablesSampleDialog::~ChangeVariablesSampleDialog()
{
    delete ui;
}

void ChangeVariablesSampleDialog::change_variables_sample()
{
// TODO: implement this
}
