 ...
 */
SeasonalAdjustmentDialog::SeasonalAdjustmentDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::seasonal_adjustment();
    ui->setupUi(this);
...
SeasonalAdjustmentDialog::~SeasonalAdjustmentDialog()
{
    delete ui;
}
