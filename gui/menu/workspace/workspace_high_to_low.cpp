 ...
 */
HighToLowDialog::HighToLowDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::high_to_low();
    ui->setupUi(this);
...
HighToLowDialog::~HighToLowDialog()
{
    delete ui;
}
