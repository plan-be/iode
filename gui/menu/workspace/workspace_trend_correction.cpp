 ...
 */
TrendCorrectionDialog::TrendCorrectionDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::trend_correction();
    ui->setupUi(this);
...
TrendCorrectionDialog::~TrendCorrectionDialog()
{
    delete ui;
}
