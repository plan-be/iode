...
#include "data_duplicate_objects.h"
 ...
 */
DuplicateObjectsDialog::DuplicateObjectsDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::duplicate_objects();
    ui->setupUi(this);
...
DuplicateObjectsDialog::~DuplicateObjectsDialog()
{
    delete ui;
}

void DuplicateObjectsDialog::duplicate_object()
{
// TODO: implement this
}
