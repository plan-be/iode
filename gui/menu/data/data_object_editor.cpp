 ...
 */
ObjectEditorDialog::ObjectEditorDialog(QSettings& settings, QWidget* parent, Qt::WindowFlags f) : MixinSettings(settings, parent, f)
{
    ui = new Ui::object_editor();
    ui->setupUi(this);
...
void ObjectEditorDialog::edit_object()
{
// TODO: implement this
}
