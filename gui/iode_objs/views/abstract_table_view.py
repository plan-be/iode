...
from PyQt6.QtWidgets import QTableView, QLineEdit, QMessageBox, QDialog
from PyQt6.QtGui import QPrinter, QTextDocument, QShortcut
...
class IodeAbstractTableView(QTableView):
    ...
    databaseModified = pyqtSignal()
    showObjsRequest = pyqtSignal(str, list)
