...
;General
  ...
  Name "IODE ${VERSION} Updater"

  ; The executable file to create
  OutFile "iode_${VERSION_PATH}_update.exe"
...
;Pages
  ...
  ; Updater pages
  !define MUI_WELCOMEPAGE_TITLE "IODE ${VERSION} Updater"
  !insertmacro MUI_PAGE_WELCOME

  !define MUI_LICENSEPAGE_TEXT_TOP "IODE ${VERSION} Updater."
  !define MUI_LICENSEPAGE_RADIOBUTTONS
  !insertmacro MUI_PAGE_LICENSE "iode_license.rtf"

  !define MUI_COMPONENTSPAGE_TEXT_TOP "IODE ${VERSION} Updater"
  !insertmacro MUI_PAGE_COMPONENTS

  !define MUI_DIRECTORYPAGE_TEXT_TOP "IODE ${VERSION} Updater" 
  !insertmacro MUI_PAGE_DIRECTORY

  !define MUI_STARTMENUPAGE_TEXT_TOP "IODE ${VERSION} Updater"
