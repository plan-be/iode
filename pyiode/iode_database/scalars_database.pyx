...
cdef class Scalars(CythonIodeDatabase):
    ...
    def _get_object(self, name: str, scalar: Scalar) -> Scalar:
        ...
        name = name.strip()
        c_scalar = self.database_ptr.get_obj_ptr(name.encode())
    ...
    def _set_object(self, name: str, scalar: Scalar):
        ...
        cdef CScalar* new_scalar_ptr = NULL
        new_scalar_ptr = self.database_ptr.set_obj_ptr(name.encode(), scalar_ptr)
        scalar.c_scalar = new_scalar_ptr
        scalar.ptr_owner = <bint>False
