...
class Identities(IodeDatabase):
    ...
    def _get_object(self, key: Union[str, int]) -> Identity:
        ...
        return self._cython_instance._get_object(key, identity)
    ...
    def print_to_file(self, filepath: Union[str, Path], names: Union[str, List[str]]=None, format: str=None):
        ...
        Loading .../fun.idt
        48 objects loaded
        >>> identities.print_to_file("identities.csv", "G*")     # doctest: +ELLIPSIS
        Printing IODE objects definition to file '...identities.csv'...
        Printing GAP2 ...
        Printing GAP_ ...
        Printing GOSFR ...
        Print done
        >>> with open("identities.csv") as f:                     # doctest: +NORMALIZE_WHITESPACE
        ...     print(f.read())
        ...
        " - GAP2 : 100*(QAFF_/(Q_F + Q_I) )"
        " - GAP_ : 100*((QAF_/Q_F) -1)"
