...
&EXTWS
&DE
La fonction ajoute un texte … la d‚finition d'un objet du WS courant.
...
&EN algorithme de r‚ordonnacement (Connex, Triangulation ou None)
...
&EN nombre d'it‚ration de tri des composantes connexes
