...
JHRead(). Le mot-cl‚ peut ˆtre en majuscules ou minuscules dans tag ou
...
/* ==================================================================
Ferme un fichier HTML ouvert … l'aide de JHOpen(). LibŠre l'espace
...
interprŠte ensuite le tag et retourne une valeur l'identifiant.
...
Les mˆmes valeurs en n‚gatif sont retourn‚es pour un tag de fin:
&EN pour /A  :  -JH_A,
&EN pour /B  :  -JH_B,
...
/* ==================================================================
Retient la derniŠre valeur lue de fa‡on … pouvoir la retourner lors du
