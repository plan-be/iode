...
&TX
&SA IS_get_read_field(), IS_set_field(), SCR_get_*(), accŠs aux valeurs
directes des ISAM
=======================================================================*/
...
Mˆme si le record courant a ‚t‚ modifi‚ depuis sa lecture, c'est la valeur
...
&TX
&SA IS_get_field(), IS_set_field(), SCR_get_*(), accŠs aux valeurs
directes des ISAM
=======================================================================*/
...
&TX
&SA IS_get_read_field(), IS_get_field(), SCR_get_*(), accŠs aux valeurs
directes des ISAM
=======================================================================*/
...
valeurs des champs … 0. Les champs de type caractŠre sont ‚galement
...
de ce champ … 0. Les champs de type caractŠre sont ‚galement
fix‚s … 0 et non … blanc.
