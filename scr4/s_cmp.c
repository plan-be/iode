...
est EQ, un record ‚gal doit ˆtre trouv‚ (pour ce qui concerne le champ
recherch‚).

&EN Copie dans la PAGE les valeurs des autres champs de l'ISAM CODE.

&EN Recommence l'op‚ration pour les autres CODES d‚finis dans ce mˆme champ.
...
/* ======================================================================
Affiche tous les champs susceptibles d'ˆtre modifi‚s par la fonction
