...
variable vaut par d‚faut "scr_err.txt". Le nom peut cependant ˆtre
...
lui-mˆme dans la langue 0, suivi du s‚parateur, etc.
...
caractŠre |. Ce caractŠre est supprim‚ du string s'il se trouve en fin
de ligne.
