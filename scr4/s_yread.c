...
/* ====================================================================
Saute la suite du texte jusqu'au prochain caractŠre non consid‚r‚ comme
...
Le pointeur vers le texte est plac‚ sur le premier caractŠre suivant.
...
/* ====================================================================
Retient le dernier ‚l‚ment lu pour lui permettre d'ˆtre relu lors de la
...
‚l‚ment logique n'est pas termin‚ par un caractŠre sp‚cial. Ainsi, pour
...
/* ====================================================================
Saute la suite du texte jusqu'au prochain caractŠre sp‚cifi‚ ou jusqu'… la
fin du fichier.
...
/* ====================================================================
Lit la suite du texte jusqu'au caractŠre sp‚cifi‚ ou jusqu'… la fin du
fichier ou jusqu'… ce que YY_MAX_STRING_LG caractŠres ne soient lus.

Les caractŠres lus sont plac‚s dans le buffer yy->yy_text.
Le caractŠre limite n'est pas plac‚ dans ce buffer.

Si la taille du buffer (YY_MAX_STRING_LG) est d‚pass‚e, la lecture
continue mais les caractŠres ne sont pas sauv‚s dans yy->yy_text,
mˆme si le caractŠre d‚sir‚ n'a pas ‚t‚ rencontr‚.

Le pointeur vers le texte est plac‚ sur le premier caractŠre suivant.

&RT le dernier caractŠre lu.
...
/* ====================================================================
Lit la suite du texte jusqu'… l'un des caractŠres sp‚cifi‚s ou jusqu'…
la fin du fichier ou jusqu'… ce que YY_MAX_STRING_LG caractŠres ne
soient lus.
...
Le pointeur vers le texte est plac‚ sur le premier caractŠre suivant le
string cible.
...
Les strings et les lettres peuvent contenir des caractŠres sp‚ciaux du
...
&EN YY_SPECIAL (*) : caractŠre non alphab‚tique sauv‚ dans
    yy->yy_text[0]
...
&EN YY_WORD (TITLE) : mot (commen‡ant par une lettre et ne contenant que
    des chiffres, des lettres ou le caractŠre _) sauv‚ dans yy->yy_text

&EN YY_UNKNOWN : directive incorrectement plac‚e (##endif sans ##ifdef
    par exemple)

&EN YY_MEMORY_FULL en cas de problŠmes d'allocation en g‚n‚ral suite …
    un ##include file
