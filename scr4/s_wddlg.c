...
/* ========================================================================
Change la police de caractŠre du contr“le fld_nb de la boŒte wddlg. Cette
fonction peut ˆtre appel‚e avant l'‚dition ou en cours d'‚dition (dans
...
/* ========================================================================
Change l'accessibilit‚ du contr“le fld_nb de la boŒte wddlg. Cette
fonction peut ˆtre appel‚e avant l'‚dition ou en cours d'‚dition (dans
une fonction utilisateur).
...
&EN fld_nb = num‚ro du contr“le concern‚ ou -1 pour changer l'accŠs de tous
    les contr“les
&EN io = accŠs choisi parmi :
&EN2 SCR_INPUT
&EN2 SCR_OUTPUT
...
boŒte wddlg. Cette fonction peut ˆtre appel‚e avant l'‚dition ou en
...
tabulation tous les 16 points de boŒte de dialogue, soit
    plus ou moins tous les 4 caractŠres.

&EN wddlg = pointeur vers la structure WDDLG contenant la description
    des contr“les
&EN fld_nb = num‚ro du contr“le LISTBOX
&EN ntabs = nombre de tabulations
&EN tabs = pointeur vers un tableau de positions en unit‚s de boŒte de
    dialogue
...
/* ========================================================================
Affiche le champ fld_nb de la boŒte de dialogue wddlg. Cette fonction
doit ˆtre appel‚e par les fonctions utilisateurs qui modifient le
...
/* ========================================================================
Affiche tous les champs de la boŒte de dialogue wddlg. Cette fonction
doit ˆtre appel‚e par les fonctions utilisateurs qui modifient le
contenu des contr“les en cours d'‚dition.
...
Cr‚e une structure de d‚finition d'une boŒte de dialogue dynamique.

&EN x = position, en pixels, du coin sup‚rieur gauche de la boŒte de
    dialogue. Si cette valeur est n‚gative, la boŒte est centr‚e
    horizontalement.
&EN y = position, en pixels, du coin sup‚rieur gauche de la boŒte de
    dialogue. Si cette valeur est n‚gative, la boŒte est centr‚e
    verticalement.
&EN cx = taille, en coordonn‚es de boŒte de dialogue (!), de la boŒte de
    dialogue.
&EN cy = taille, en coordonn‚es de boŒte de dialogue (!), de la boŒte de
    dialogue.
&EN title (optionnel) = titre de la boŒte de dialogue. Si title est nul
    il n'y a pas de titre dans la boŒte de dialogue.
...
/* ===================================================================
Ajoute un bouton … une boŒte de dialogue dynamique.

&EN wddlg = pointeur vers la structure de d‚finition de la boŒte de
    dialogue dynamique cr‚‚e par WDDlgCreate()
&EN (x, y) = position, en coordonn‚es de boŒte de dialogue, du coin
    sup‚rieur gauche du contr“le
&EN (cx, cy) = taille du contr“le, en coordonn‚es de boŒte de dialogue
&EN text = pointeur vers le texte du bouton (valeur du contr“le)
&EN fn = pointeur vers la fonction utilisateur de gestion des ‚vŠnements
    du contr“le
...
&EN fld_nb est le num‚ro du contr“le courant (o— s'est produit
    l'‚vŠnement)
&EN txt est la valeur du contr“le (= text de WDDlgAddButton)
&EN nNotif est le message Windows re‡u dans le contr“le
...
la boŒte de dialogue est quitt‚e et la valeur de fn est retourn‚e par
...
/* ===================================================================
Ajoute une LISTBOX … une boŒte de dialogue dynamique.
...
/* ===================================================================
Ajoute un contr“le statique (texte) … une boŒte de dialogue dynamique.
...
/* ===================================================================
Ajoute un ic“ne dans une boŒte de dialogue dynamique.
...
/* ===================================================================
Ajoute un BITMAP dans une boŒte de dialogue dynamique.
Si fn est non nulle, le contr“le est "clickable".
...
/* ===================================================================
Ajoute un GROUPBOX dans une boŒte de dialogue dynamique.

&EN wddlg = pointeur vers la structure de d‚finition de la boŒte de
    dialogue dynamique cr‚‚e par WDDlgCreate()
&EN (x, y) = position, en coordonn‚es de boŒte de dialogue, du coin
    sup‚rieur gauche du contr“le
&EN (cx, cy) = taille, en coordonn‚es de boŒte de dialogue, du
    group box
...
/* ===================================================================
Ajoute un contr“le d'‚dition de texte d'une seule ligne … une boŒte de
dialogue dynamique.
...
/* ===================================================================
Ajoute un slider horizontal dans une boŒte de dialogue dynamique.
...
/* ===================================================================
Ajoute un "progress bar" dans une boŒte de dialogue dynamique.
...
/* ===================================================================
Edite une boŒte de dialogue dynamique construite … l'aide de
WDDlgCreate() et WDDlgAdd*().

&RT Diff‚rentes valeurs sont possibles selon la maniŠre choisie
...
/* ===================================================================
Affiche une boŒte de dialogue dynamique construite … l'aide de
WDDlgCreate() et WDDlgAdd*().

&RT 0 si la fenˆtre est cr‚‚e, -1 sinon
...
/* ===================================================================
Ferme une boŒte de dialogue dynamique construite … l'aide de
WDDlgCreate() et WDDlgAdd*() et affich‚e par WDDlgDisplay().

&RT -1 si la fenˆtre n'existe pas
...
/* ===================================================================
LibŠre l'espace allou‚ pour la cr‚ation d'une boŒte de dialogue
...
/* ========================================================================
Affiche une liste d'options dans une boŒte de dialogue dynamique et
permet d'en s‚lectionner une ou plusieurs. Cette fonction fait appel au
groupe de fonctions WDDlg. La s‚lection s'opŠre dans une LISTBOX standard
de Windows.

La boŒte de dialogue propos‚e contient une LISTBOX et deux ou trois
...
coordonn‚es de boŒte de dialogue. Ces derniŠres repr‚sentent la taille
moyenne d'un caractŠre dans la police utilis‚e dans la boŒte de dialogue
...
&EN opts = tableau de pointeurs vers les options … afficher. Les options
    ...
    colonnes
&EN sels (optionnel) = tableau de caractŠres, 0 pour option non
    s‚lectionn‚e, 1 pour option s‚lectionn‚e. Le nombre d'‚l‚ments de
    sels doit correspondre … celui de opts. Si sels est nul, la
    s‚lection ne peut ˆtre multiple et la valeur de retour de la
...
&EN tabs (optionnel) = position des tabs dans la LISTBOX (exprim‚s en
    coordonn‚es de la boŒte de dialogue). Par d‚faut, un tab est plac‚
    tous les 16 points (soit plus ou moins 4 caractŠres).
...
Affiche une liste d'options dans une boŒte de dialogue dynamique et
permet d'en s‚lectionner une ou plusieurs. Cette fonction fait appel au
groupe de fonctions WDDlg. La s‚lection s'opŠre dans une "LISTVIEW",
...
La boŒte de dialogue propos‚e contient une LISTVIEW et deux ou trois
boutons : Ok, Cancel et Select All si les s‚lections multiples sont
permises (selon la valeur de sels).
...
&EN opts = tableau de pointeurs vers les options … afficher. Les options
    ...
    colonnes. La premiŠre option contient les titres de colonnes.
&EN sels (optionnel) = tableau de caractŠres, 0 pour option non
    s‚lectionn‚e, 1 pour option s‚lectionn‚e. Le nombre d'‚l‚ments de
    sels doit correspondre … celui de opts. Si sels est nul, la
    s‚lection ne peut ˆtre multiple et la valeur de retour de la
...
/* ===================================================================
Ajoute un contr“le LISTVIEW … une boŒte de dialogue dynamique.
...
&EN WDDLG_KILLFOCUS : perte du focus
&EN WDDLG_SETFOCUS  : gain du focus
&EN WDDLG_CHANGED : changement de s‚lection. Ce message est re‡u …
...
&EN wddlg = pointeur vers la boŒte de dialogue
...
/* ========================================================================
Cr‚e une boŒte de dialogue dynamique temporaire pour poser une question.
La r‚ponse se trouve dans le buffer rep.

&EN title = titre de la boŒte de dialogue
...
l'‚dition de la boŒte de dialogue. Cette fonction doit retourner une
valeur non nulle pour que la boŒte de dialogue soit quitt‚e par ESCAPE
et nulle sinon.

Par d‚faut, ESCAPE quitte la boŒte de dialogue.
...
de ce type, ENTER quitte la boŒte de dialogue.
...
/* ========================================================================
Fixe la fonction … ex‚cuter lors du d‚but de l'‚dition de la boŒte de
dialogue wddlg. Cette fonction doit retourner une valeur non nulle pour
que la boŒte de dialogue ne soit pas ‚dit‚e et nulle pour que l'‚dition
d‚bute.

La fonction est ex‚cut‚e avant la cr‚ation de la fenˆtre.
...
de la boŒte de dialogue wddlg. Cette fonction doit retourner une
valeur nulle pour que la boŒte de dialogue puisse ˆtre quitt‚e
...
/* ========================================================================
Change le texte de l'option opt_nb de la LISTBOX fld_nb de la boŒte wddlg.
...
/* ========================================================================
Fixe le focus sur le champ fld_nb de la boŒte wddlg.
...
/* ========================================================================
Cr‚e une boŒte de dialogue dynamique temporaire avec une question et plusieurs boutons.
...
/* ========================================================================
Cr‚e une boŒte de dialogue modeless avec un texte variable dans msg.
...
/* ========================================================================
Affiche le menu mn sous forme d'une ListView. La fenˆtre ListView est
ind‚pendante. Elle est plac‚e relativement … la PAGE pg et au champ fld_nb.

&EN mn : menu de r‚f‚rence
&EN sep : caractŠre de s‚paration des colonnes. Dans chaque ligne du menu,
on a un nombre identique de colonnes s‚par‚es par ce caractŠre.
&EN istitle : indique si la premiŠre option du menu contient le titre … afficher comme
    titre du ListView
...
Une seule option peut ˆtre s‚lectionn‚e. Le fait de presser ENTER retourne
