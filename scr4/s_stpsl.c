...
Les caractŠres en dehors des ‚tiquettes sont ignor‚s.

Les paramŠtres sont semblables … ceux de PS_text() :

&EN ifl : input filename. Si nul, stdin.
&EN ofl : output filename. Si nul, stdout.
&EN font : police de caractŠre. Si nul, "Helvetica"
...
Le papier est divis‚ en rectangles correspondant … ces paramŠtres.
