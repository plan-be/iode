...
int A2mToRtf(char * a2mfile, char * outfile, int wh)
{
    A2MFILE *af;
    A2MOBJ  *ao;
    int     rc;
...
/*NH*/
int A2mRtfInit(char * outfile, int wh)
{
    char        buf[256];
...
/*NH*/
int A2mRtfPrintTopic(A2MTOP * atp)
{
...
/*NH
int A2mRtfPrintTopicCnt(A2MTOP * atp)
{
    int     clevel = 0;
...
/*NH*/
int A2mRtfPrintCntTxt(U_ch * txt)
{
    int     i;
...
/*NH*/
int A2mRtfPrintPar(A2MPAR * ap, int tbl)
{
    int     i, curimg;
...
/*NH*/
int A2mRtfPrintTxt(FILE * fd, U_ch * txt)
{
    int     i;
...
/*NH*/
int A2mRtfPrintStr(A2MPAR * ap, int n)
{
...
/*NH*/
int A2mRtfPrintStrImage(A2MPAR * ap, int n)
{
    A2MSTR  *as = ap->ap_strs[n];
...
/*NH*/
int A2mRtfPrintAttr(A2MPAR * ap, int n)
{
    A2MFNT  fnt;
...
/*NH*/
int A2mRtfPrintChar(FILE * fd, int ch)
{
...
/*NH*/
int A2mRtfPrintTblLines(A2MTBL * at, int hbf)
{
    A2MTC   *tc;
    int     i, j, line = 0;
...
/*NH*/
int A2mRtfCellxs(A2MTBL * at, int line, int hbf, int hline)
{
    A2MTC   *tc;
    int     i, k, fl, ll;
    long    pos, nc;
...
/*NH*/
int A2mRtfCalcFirstLine(A2MTBL * at, int hbf)
{
    int     i;
...
/*NH*/
int A2mRtfCalcLastLine(A2MTBL * at, int hbf)
{
    int     i, last = -1;
...
/*NH*/
int A2mRtfAFrame(char * filename, int type)
{
    char    buf[128];
...
int A2mRtfReadIni(char * filename)
{
    U_ch    buf[256];
