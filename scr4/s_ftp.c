...
/* ==========================================================================
    ...
    socket : IN : socket de connexion
    dir    : IN : sous-r‚pertoire à créer
    return : 0 : si ok
	     -1 : Si le répertoire n'a pu être créé
============================================================================= */
...
ScrFtpPutFile(int socket, char *file, char *to)
{
    ...
    // Le message re‡u du serveur contient l'adresse IP et le port TCP/IP
    // o— se connecter et envoyer les donn‚es
...
/* ==============================================================
    ...
    res    : OUT: r‚pertoire courant du serveur FTP
		  ...
		  sinon res doit ˆtre assez long pour contenir le r‚sultat
    return : 0 : si ok
	     -1 : Si l'envoi de la commande … ‚chou‚
	     -2 : Si le fichier n'existe pas
================================================================= */
