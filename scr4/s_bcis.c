...
&TX
&SA BC_get_lbc_field(), accŠs aux valeurs directes des BC
=======================================================================*/
...
&SA BC_get_lbc_field(), BC_lpg_rec(), accŠs aux valeurs directes des BC
=======================================================================*/
...
&SA BC_get_lbc_field(), BC_lbc_rec(), accŠs aux
