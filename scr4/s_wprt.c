...
/* ======================================================================
Cette fonction d‚finit la police de caractŠres qui sera utilis‚e lors
...
Le choix de la police s'opŠre en fonction de ce qui est disponible
sur l'unit‚ de destination).

Les polices utilis‚es sont conserv‚es pendant toute la dur‚e de
l'impression de fa‡on … optimiser la vitesse de basculement d'une police
… l'autre.
