...
/* ======================================================================
Lit la valeur lue dans le record ISAM du iŠme champ qui suit l'objet
...
doit ˆtre un index de l'ISAM. La recherceh s'effectue suivant l'ordre de cet
index.
...
de l'ISAM. Un champ d'une page pouvant ˆtre li‚ … plusieurs champs
