...
/*NH
Retourne le nbre de lignes des headers non compris la derniŠre ligne blanche
*/
...
POP3MSG *msg;
{
    ...
    /* Lecture complŠte du texte du message */
    sprintf(buf, "RETR %d\r\n", i);
...
/*============================================================================
LibŠre une structure POP3MSG et toutes les sous-structures.
...
/*============================================================================
LibŠre un tableau de structures POP3MSG.
...
&EN int sock : socket retourn‚ par Pop3Connect()
&EN int msgnb : num‚ro du message (commen‡ant … 1)
...
&EN char *filename : nom du fichier r‚sultat ou 0 ou string vide. Si 0 ou
    string vide, la piŠce est sauv‚e sous le nom qu'elle avait … l'envoi du
...
&EN base64, mais pose problŠme avec Outlook et les fichiers .doc et autres qui contiennent
...
&EN -4 si le fichier cible ne peut ˆtre ouvert
...
/*============================================================================
D‚tache une piŠce jointe et la sauve dans un fichier.
...
&RT
&EN 0 si Ok
&EN -1 si message non d‚fini ou pas de piŠces jointes
&EN -2 si filename est nul et pas de nom de fichier dans le message
&EN -3 si l'attachment est vide
&EN -4 si le fichier cible ne peut ˆtre ouvert
...
/*============================================================================
Session complŠte de lecture de message sur un serveur POP3.
