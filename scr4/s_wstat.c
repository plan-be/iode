...
/* =================================================================
Change le message de la ligne d'Çtat de la fenàtre hWnd. Si hWnd est
nul, affiche dans la derniäre fenàtre Popup de l'application en cours.

Si une telle fenàtre n'existe pas, retourne sans afficher.
==================================================================== */
