...
AprŠs l'impression de la PAGE, le curseur d'impression est plac‚ dans la
mˆme ligne, mais … droite de la PAGE imprim‚.

&NO
    La position de la PAGE dans l'‚cran (line et col) sont prises en
    compte pour d‚caler la page … l'impression. La fonction
    PR_page_clf() r‚soud ce problŠme.
&EX
    PR_page(pg1);
&TX
&SA PR_page_clf()
...
AprŠs l'impression de la PAGE, le curseur d'impression est plac‚ en
premiŠre colonne sous la PAGE imprim‚e.
