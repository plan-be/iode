...
&EN Le premier champ de type PASSWD est lu et compar‚ (aprŠs strip)
...
&EN AprŠs nbtry essais, la fonction SCR_end() est appel‚e pour quitter
    l'application
...
&EN Le premier champ de type PASSWD est lu et compar‚ (aprŠs strip)
    au mot de passe pwd pass‚ comme argument. Si le champ correspond,
    le 2Šme et le 3Šme PASSWD doivent ˆtre ‚gaux. Le 2Šme est alors copi‚
