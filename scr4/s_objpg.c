...
/* ======================================================================
Retourne le pointeur vers le texte du iŠme champ (de type STRING) qui
...
&TX
&RT pointeur vers le premier caractŠre du champ
------------------------------------------------------------------------ */
...
/* ======================================================================
Change l'attribut input/output du iŠme champ qui suit l'objet obj d'une
...
&NO
    Les champs de la PAGE doivent ˆtre en m‚moire. Utilisez le mot-cl‚
...
/* ======================================================================
Retourne l'attribut input/output du iŠme champ qui suit l'objet obj d'une
PAGE.
...
/* ======================================================================
Change l'attribut couleur du iŠme champ qui suit l'objet obj d'une
...
/* ======================================================================
Affiche le iŠme champ qui suit l'objet obj d'une PAGE.
...
/* ======================================================================
Edite le iŠme champ qui suit l'objet obj d'une PAGE.
...
/* ======================================================================
Change la valeur par d‚faut du iŠme champ qui suit l'objet obj d'une
...
/* ======================================================================
Vide le iŠme champ qui suit l'objet obj d'une PAGE, quelqu'en soit le
type (0 ou blancs).
------------------------------------------------------------------------ */
