...
&EN volname = nom du drive retourn‚ en cas de succŠs, sinon '' (buffer de 128 bytes requis)
&EN volsn   = long num‚ro de s‚rie du disque par la fonction en cas de succŠs
