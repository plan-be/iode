...
#ifdef __cplusplus
char** SCR_vtoms(char* vec, char* seps)
{
    char** res;

    res = (char**)SCR_vtoms((unsigned char*)vec, (unsigned char*)seps);
    return(res);
}
#endif
...
void Tests_Simulation()
{
    ...
    //endo_exo = SCR_vtoms((U_ch*)"UY-XNATY", (U_ch*)",; ");
    endo_exo = SCR_vtoms("UY-XNATY", ",; ");
    //arg1 = (U_ch*)"UY-XNATY";
    //arg2 = (U_ch*)",; ";
    //endo_exo = SCR_vtoms(arg1, arg2);
...
void Tests_PrintTables()
{
    ...
    // Just a test => access violation: "..." is const char[] meaning that it is RO
    // SCR_sqz((unsigned char*)"  abc d d "); 
