...
void Tests_B_FSYS()
{
    ...
    S4ASSERT(cond == 1, "B_SysAnsiToOem(\"toto.a2m toto.a2m.oem\")");
    ...
    S4ASSERT(cond == 1, "B_SysAnsiToUTF8(\"toto.a2m toto.a2m.utf8\")");
    ...
    S4ASSERT(cond == 1, "B_SysOemToAnsi(\"toto.a2m.ansi toto.a2m.ansi.ref\")");
  
    // B_SysOemToUTF8() : translate ansi to utf8 -> toto.a2m.utf8
    rc = B_SysOemToUTF8("toto.a2m.oem toto.a2m.utf8"); 
    cond = (rc == 0) && U_test_compare_outfile_to_reffile("toto.a2m.utf8", "toto.a2m.utf8.ref");
    S4ASSERT(cond == 1, "B_SysOemToUTF8(\"toto.a2m.oem toto.a2m.utf8\")");
    ...
    S4ASSERT(cond == 1, "B_SysRename(\"toto.a2m.ansi brol.a2m.ansi\")");
    ...
    S4ASSERT(cond == 1, "B_SysCopy(\"brol.a2m.ansi totodbl.a2m.ansi\")");
    ...
    S4ASSERT(cond == 1, "B_SysAppend(\"brol.a2m.ansi totodbl.a2m.ansi \")");
...
int U_test_B_WsCopyVar()
{
    ...
    S4ASSERT(cond != 0, "B_WsCopy(\"%s\", K_VAR) == 0", arg);
...
{    
    ...
    cond =  (rc == 0) && 
            (U_test_eq(ACAF92, 30.159000) != 0) &&
            (U_test_eq(ACAG92, -40.286) != 0);
    S4ASSERT(cond != 0, "B_WsMerge(\"%s\", K_VAR) == 0", arg);
