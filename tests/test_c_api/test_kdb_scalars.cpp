...
TEST_F(KDBScalarsTest, Subset)
{
    ...
    // DEEP COPY SUBSET
    std::shared_ptr<KDBScalars> kdb_subset_deep_copy = new KDBScalars(global_ws_scl, pattern, true);
    ...
    // SHALLOW COPY SUBSET
    std::shared_ptr<KDBScalars> kdb_subset_shallow_copy = new KDBScalars(global_ws_scl, pattern, false);
...
TEST_F(KDBScalarsTest, Filter)
{
    ...
    kdb_subset = new KDBScalars(global_ws_scl, pattern, false);
    ...
    // wrong pattern
    pattern = "anjfks";
    EXPECT_THROW(KDBScalars(global_ws_scl, pattern, false), std::runtime_error);
}
...
TEST_F(KDBScalarsTest, DeepCopy)
{
    ...
    kdb_subset = new KDBScalars(global_ws_scl, pattern, true);
    EXPECT_EQ(kdb_subset->size(), expected_names.size());
    EXPECT_EQ(kdb_subset->get_names(), expected_names);
...
TEST_F(KDBScalarsTest, Merge)
{
    ...
    std::shared_ptr<KDBScalars> kdb0 = new KDBScalars(global_ws_scl, pattern, true);
    std::shared_ptr<KDBScalars> kdb1 = new KDBScalars(global_ws_scl, pattern, true);
    std::shared_ptr<KDBScalars> kdb_to_merge = new KDBScalars(global_ws_scl, pattern, true);
