...
TEST_F(KDBCommentsTest, Subset)
{
    ...
    // DEEP COPY SUBSET
    std::shared_ptr<KDBComments> kdb_subset_deep_copy = new KDBComments(global_ws_cmt, pattern, true);
    ...
    // SHALLOW COPY SUBSET
    std::shared_ptr<KDBComments> kdb_subset_shallow_copy = new KDBComments(global_ws_cmt, pattern, false);
...
TEST_F(KDBCommentsTest, Filter)
{
    ...
    kdb_subset = new KDBComments(global_ws_cmt, pattern, false);
    ...
    // wrong pattern
    pattern = "anjfks";
    EXPECT_THROW(KDBComments(global_ws_cmt, pattern, false), std::runtime_error);
    ...
    std::shared_ptr<KDBComments> kdb_subset_subset = new KDBComments(kdb_subset, pattern_subset_subset, false);
...
TEST_F(KDBCommentsTest, DeepCopy)
{
    ...
    kdb_subset = new KDBComments(global_ws_cmt, pattern, true);
    EXPECT_EQ(kdb_subset->size(), expected_names.size());
    EXPECT_EQ(kdb_subset->get_names(), expected_names);
...
TEST_F(KDBCommentsTest, Merge)
{
    ...
    std::shared_ptr<KDBComments> kdb0 = new KDBComments(global_ws_cmt, pattern, true);
    std::shared_ptr<KDBComments> kdb1 = new KDBComments(global_ws_cmt, pattern, true);
    std::shared_ptr<KDBComments> kdb_to_merge = new KDBComments(global_ws_cmt, pattern, true);
