...
// Fonctions annul�es/remplac�es temporairement pour passer le link
...
void Tests_B_FSYS()
{
    ...
    // => Pb avec la conversion test_c_api => les fichiers diff�rent entre celui cr�� via test1.c
    // et celui cr�� par test_c_api.cpp. Donc on va prendre une copie de data\toto.a2m
